const DO_RULES = [
  ...
  "Search first — avoid posting duplicate deals.",
  ...
  "Only post deals available in the UAE.",
];

const DONT_RULES = [
  "Post duplicate deals.",
  "Use affiliate, referral, or tracking links.",
  "Post adult, gambling, or prohibited content.",
  "Post job listings, auctions, or private sales.",
...
export function PostingRulesSidebar() {
  return (
    <div className="thick-rule space-y-4 p-4">
      <h2 className="font-display font-bold text-foreground">Posting Rules</h2>
